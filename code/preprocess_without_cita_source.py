...
train.to_csv("train_without_cita_source.csv")
test.to_csv("test_without_cita_source.csv")
...
grid = GridSearchCV(estimator=eclf, param_grid={}, cv=5, scoring='f1')
...
with open("submission_without_citation_source.csv", "w") as pred1:
