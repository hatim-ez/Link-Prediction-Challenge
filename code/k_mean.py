...
def k_mean(data, num_clusters):
    ...
    clusters = kmeans_algorithm(points, num_clusters, cutoff)
...
class Cluster(object):
    ...
    def calculate_centroid(self):
        ...
        idx_point = np.argmin([get_euclidean_distance(centroid, point) for point in self.points])


        return centroid

def kmeans_algorithm(points, k, cutoff):
